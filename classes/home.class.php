			...
			$retr = "
                <div class=block>
                    <div class=block_title>Status</div>
		  			<div class=pairs>
                        <div class=pair><div class=key>Environment</div><div class=value>".(IS_DEVEL_ENVIRONMENT ? "⚙️ Development" : "✅ Production")."</div></div>
						<div class=pair><div class=key>Delivery</div><div class=value>".(isFlag("paused") ? "⚠️ Paused" : "✅ Delivering")."</div></div>
